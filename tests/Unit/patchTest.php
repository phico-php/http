...
test('can make PATCH request', function () {
    ...
    $response = http()
        ->patch('https://posttestserver.dev/p/2wh0926slgdimnm2/post');
...
test('can make PATCH request with params', function () {
    ...
    $response = http()
        ->patch('https://posttestserver.dev/p/2wh0926slgdimnm2/post', $params);
