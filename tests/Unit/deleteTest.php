...
test('can make DELETE request', function () {
    ...
    $response = http()
        ->delete('https://posttestserver.dev/p/2wh0926slgdimnm2/post');
...
test('can make DELETE request with params', function () {
    ...
    $response = http()
        ->delete('https://posttestserver.dev/p/2wh0926slgdimnm2/post', $params);
