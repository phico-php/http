...
test('can make PUT request', function () {
    ...
    $response = http()
        ->put('https://posttestserver.dev/p/2wh0926slgdimnm2/post');
...
test('can make PUT request with params', function () {
    ...
    $response = http()
        ->put('https://posttestserver.dev/p/2wh0926slgdimnm2/post', $params);
